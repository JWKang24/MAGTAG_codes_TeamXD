...
def index(request: Request):
    print("GET / from", request.client)
    html = "<html><body><h2>MagTag server running ✅</h2></body></html>"
    return Response(request, html, content_type="text/html")

# IMPORTANT: start() signature differs across versions.
# This works on current adafruit_httpserver:
...
# ----------------------------
while True:
    server.poll()          # must be called often
    time.sleep(0.01)